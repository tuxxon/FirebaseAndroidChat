package com.touchizen.firebaseandroidchat.adapter;
...
public class ChatFirebaseAdapter extends FirebaseRecyclerAdapter<ChatModel,ChatFirebaseAdapter.MyChatViewHolder> {
     ...
     * @param options
     */
    public ChatFirebaseAdapter(@NonNull FirebaseRecyclerOptions<ChatModel> options) {
        super(options);
    }

    public ChatFirebaseAdapter(@NonNull FirebaseRecyclerOptions<ChatModel> options, String nameUser,ClickListenerChatFirebase mClickListenerChatFirebase) {
        super(options);
...
//            viewHolder.setIvChatPhoto(com.touchizen.firebaseandroidchat.util.Util.local(model.getMapModel().getLatitude(),model.getMapModel().getLongitude()));
//            viewHolder.tvIsLocation(View.VISIBLE);
//        }
//    }

    @Override
    protected void onBindViewHolder(@NonNull MyChatViewHolder viewHolder, int position, @NonNull ChatModel model) {
